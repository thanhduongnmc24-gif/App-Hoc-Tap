...
export const LOTTIE_ANIMALS = [
  ...
  require('../assets/lottie/Cow Drink Milk.json'),
  ...
  require('../assets/lottie/Just a pigeon..json'),
  require('../assets/lottie/Meditating Giraffe.json'),
  require('../assets/lottie/Tiger Happy.json'),
  require('../assets/lottie/animation.json'),
  require('../assets/lottie/ninja.json'),
];
